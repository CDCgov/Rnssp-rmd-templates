...
params:
  ...
  definition: 
    ...
    value: !r  dplyr::pull(head(readRDS(file.path("https://raw.githubusercontent.com", "cdcgov", "Rnssp-rmd-templates", "master", "text_mining", "skeleton", "syndef.rds")), 1), syndrome)
    input: select
    choices: !r dplyr::pull(readRDS(file.path("https://raw.githubusercontent.com", "cdcgov", "Rnssp-rmd-templates", "master", "text_mining", "skeleton", "syndef.rds")), syndrome)
---
