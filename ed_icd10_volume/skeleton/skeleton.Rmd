...
if (str_contains(params$site_facility, pattern = "&datasource=va_hosp", ignore.case = TRUE, logic = "not")==TRUE &
  ...
  knitr::knit_exit("Render ends prematurely.
                   It looks like you are trying to run this report for a single facility. Please make sure your facility query is a Facility Location query in ESSENCE.
...
if (str_contains(params$site_facility, pattern = "&datasource=va_hosp", ignore.case = TRUE)==TRUE &
  ...
  knitr::knit_exit("Render ends prematurely.
                   It looks like you are trying to run this report for a single facility. Please make sure your ESSENCE API URL has a facility selected.
