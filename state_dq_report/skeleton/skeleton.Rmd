...
description: "This is a site-level data quality report that generates metrics similar to the NSSP Data Quality dashboards. It utilizes your site's Production Processed table and the ESSENCE application programming interface (API) to assess the data quality of the selected C_Patient_Class in your jurisdiction. Please knit with parameters within the NSSP RStudio Workbench. Note: this report will not work in other instances of RStudio."
output:
  html_document:
    toc: true
params:
...
Table values are colored according to their NSSP timeliness category, with green denoting less than 24 hours, blue denoting between 24 and 48 hours, and red denoting greater than 48 hours.
...
Table values are colored according to their NSSP timeliness category, with green denoting values less than 24 hours, blue denoting values between 24 and 48 hours, and red denoting values greater than 48 hours.
...
## Validity by Message Field by Facility (`r paste0(sitename)`\_PR_Processed Table)
