...
[^1]: Facility counts, patient counts, and message counts may vary based on the time period included in the report and when the report was run. Patient visit counts pulled from the processed table will not precisely match visit counts pulled from ESSENCE.
...
plot.ccavailable <- ggplot(cc.available) +
  ...
  annotate("text", x = min(cc.informative$date) + days(7), y = 74.5, label = "NSSP Completeness Threshold") +
