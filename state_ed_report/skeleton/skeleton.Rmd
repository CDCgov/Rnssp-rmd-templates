...
params:
  ...
  ccdd_categories:
    ...
    choices: !r fl <- tempfile(fileext =".rds"); download.file(file.path("https://raw.githubusercontent.com", "cdcgov", "Rnssp-rmd-templates", "master", "state_ed_report", "skeleton", "ccdd_cat.rds"), destfile = fl); dplyr::pull(readRDS("ccdd_cat.rds"), ccdd_category)
    input: select
    multiple: yes
  start_date:
