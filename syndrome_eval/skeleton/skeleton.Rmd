...
params:
  ...
  custom_query_label1:
    label: "Enter label for Free Text Query1"
    value: ""
    input: text
  ...
  custom_query2: 
    ...
    placeholder: "Free Text Query e.g.: ^[;/ ]J10^,OR,^[;/ ]J.10^"
  custom_query_label2:
    label: "Enter label for Free Text Query2"
    value: ""
    input: text
    placeholder: "Influenza"
  custom_query3: 
    ...
    placeholder: "Free Text Query e.g.: ^[;/ ]J10^,OR,^[;/ ]J.10^"
  custom_query_label3:
    label: "Enter label for Free Text Query3"
    value: ""
    input: text
    placeholder: "Influenza"
  doc_title:
...
```{r def2_table, echo=FALSE, message=FALSE, warning=FALSE, eval=length(params2$definition) >= 2}
...
```{r def3_table, echo=FALSE, message=FALSE, warning=FALSE, eval=length(params2$definition) > 2}
